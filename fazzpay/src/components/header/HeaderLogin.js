    ...
    <div>
      <header className="flex justify-between mx-20">
        ...
        <div className="lg:block sm:none">
          <button className="border border-primary px-6 py-2 rounded-xl font-semibold text-primary mx-2 hover:border-transparent ease-in-out duration-100 hover:bg-primary hover:text-white active:scale-95">
            Login
          </button>
